...
Public Class kaskeluar
    ...
    Sub simpan()
        koneksi()
        Dim sql As String = "insert into tb_kaskeluar values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "')"
    ...
    Sub tampil()
        ...
        Try
            koneksi()
            da = New OdbcDataAdapter("select *from tb_kaskeluar order by id_kas asc", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Else
           ...
           Windows.Forms.DialogResult.OK) Then
                koneksi()
                cmd = New OdbcCommand("delete from tb_kaskeluar where id_kas='" & a &
               "'", con)
                cmd.ExecuteNonQuery()
